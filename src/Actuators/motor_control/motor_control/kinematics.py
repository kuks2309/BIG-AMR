...
#       이상거동이 아니라 호밍 완료 후 원점(음 리밋)에서 펌웨어 GOZERO 목표로 이동하는 설계된
#       동작이다. ⚠ 그 목표는 **조향 0° 가 아니다** — SEER_HOME_ZERO_N3/N4(7,882,020 / 7,859,062,
#       `Tools/Can_Relay/panda-firmware/board/safety/safety_seer_gate.h:212-213`)는 호밍 후 정착값이며
#       조향 0° 정본 [7871815, 7840086] 에서 +0.178° / +0.331° 떨어져 있다. 펌웨어에는 0° 로 보내는
#       동작이 없고, 0° 복귀는 호스트가 별도로 지령해야 한다(can_relay `steer_to_zero()`).

...
and follows that job until it arrives. That is all a CSM is.
...
python3 -m csm.supervised_demo --seconds 20 --robots 1
...
ros2 run csm seer_client --host 192.168.44.82
```

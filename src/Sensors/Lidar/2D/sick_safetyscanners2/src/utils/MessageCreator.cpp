...
MessageCreator::MessageCreator(std::string frame_id, double time_offset, double range_min, double range_max,
                               float angle_offset, double min_intensities)
    : m_frame_id(frame_id), m_time_offset(time_offset), m_range_min(range_min), m_range_max(range_max),
      m_angle_offset(angle_offset), m_min_intensities(min_intensities)
{
}
...
sensor_msgs::msg::LaserScan MessageCreator::createLaserScanMsg(const sick::datastructure::Data &data, rclcpp::Time now)
{
    ...
    scan.angle_max =
        scan_points.empty() ? scan.angle_min : sick::degToRad(scan_points.back().getAngle() + m_angle_offset);
...
sick_safetyscanners2_interfaces::msg::OutputPaths MessageCreator::createOutputPathsMsg(
...
sick_safetyscanners2_interfaces::msg::ExtendedLaserScan MessageCreator::createExtendedLaserScanMsg(
...
std::vector<bool> MessageCreator::getMedianReflectors(const std::vector<sick::datastructure::ScanPoint> scan_points)
{
    std::vector<bool> res;
...
sick_safetyscanners2_interfaces::msg::RawMicroScanData MessageCreator::createRawDataMsg(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::DataHeader MessageCreator::createDataHeaderMsg(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::DerivedValues MessageCreator::createDerivedValuesMsg(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::GeneralSystemState MessageCreator::createGeneralSystemStateMsg(
    const sick::datastructure::Data &data)
{
    ...
    {
        std::shared_ptr<sick::datastructure::GeneralSystemState> general_system_state = data.getGeneralSystemStatePtr();
        ...
        msg.current_monitoring_case_no_table_1 = general_system_state->getCurrentMonitoringCaseNoTable1();
        msg.current_monitoring_case_no_table_2 = general_system_state->getCurrentMonitoringCaseNoTable2();
        msg.current_monitoring_case_no_table_3 = general_system_state->getCurrentMonitoringCaseNoTable3();
        msg.current_monitoring_case_no_table_4 = general_system_state->getCurrentMonitoringCaseNoTable4();
...
sick_safetyscanners2_interfaces::msg::MeasurementData MessageCreator::createMeasurementDataMsg(
    const sick::datastructure::Data &data)
{
...
std::vector<sick_safetyscanners2_interfaces::msg::ScanPoint> MessageCreator::createScanPointMsgVector(
    const sick::datastructure::Data &data)
{
    std::vector<sick_safetyscanners2_interfaces::msg::ScanPoint> msg_vector;

    std::shared_ptr<sick::datastructure::MeasurementData> measurement_data = data.getMeasurementDataPtr();
...
sick_safetyscanners2_interfaces::msg::IntrusionData MessageCreator::createIntrusionDataMsg(
    const sick::datastructure::Data &data)
{
...
std::vector<sick_safetyscanners2_interfaces::msg::IntrusionDatum> MessageCreator::createIntrusionDatumMsgVector(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::ApplicationData MessageCreator::createApplicationDataMsg(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::ApplicationInputs MessageCreator::createApplicationInputsMsg(
    const sick::datastructure::Data &data)
{
...
sick_safetyscanners2_interfaces::msg::ApplicationOutputs MessageCreator::createApplicationOutputsMsg(
    const sick::datastructure::Data &data)
{

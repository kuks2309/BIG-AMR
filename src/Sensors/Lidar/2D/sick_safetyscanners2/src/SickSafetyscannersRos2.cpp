...
SickSafetyscannersRos2::SickSafetyscannersRos2() : Node("SickSafetyscannersRos2")
{
    ...
    m_field_data_service = this->create_service<sick_safetyscanners2_interfaces::srv::FieldData>(
        "field_data",
        std::bind(&SickSafetyscannersRos2::getFieldData, this, std::placeholders::_1, std::placeholders::_2));
    ...
    setupCommunication(std::bind(&SickSafetyscannersRos2::receiveUDPPaket, this, std::placeholders::_1));

...
class SickSafetyscannersRos2 : public rclcpp::Node, public SickSafetyscanners
{
  ...
  private:
    ...
    rclcpp::Publisher<sick_safetyscanners2_interfaces::msg::OutputPaths>::SharedPtr m_output_paths_publisher;
    rclcpp::Publisher<sick_safetyscanners2_interfaces::msg::RawMicroScanData>::SharedPtr m_raw_data_publisher;

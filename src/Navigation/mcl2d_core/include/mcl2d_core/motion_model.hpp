...
// (ParticleFilter2D::Whats2Run 의 kMove / kExtraMove — ThreadFunc1/2 가 switch 로 택일):  comment-check: ignore
...
// 산포 크기 선택 (Seer MCLoc::DoNormalUpdateAction 의 모드 결정 트리, CFG 추적으로 복원).  comment-check: ignore

#ifndef TRNAV_2WS_KINEMATICS__QD_CRAB_INVERSE_KINEMATICS_HPP_
#define TRNAV_2WS_KINEMATICS__QD_CRAB_INVERSE_KINEMATICS_HPP_
...
// TwoWsCrabIK — CRAB linear 전용 IK (rear-steer heading 보정 지원).
//
...
//  - rear_raw = base_raw - delta_heading  (dir 계수 없음 — qd_crab_inverse_kinematics.cpp:63)
//  - walk direction 은 vx_path 부호 (+ wrap 시 wheel 별 flip 가능)
//  - wheel speed 양 휠 동일 |vx_path|
class TwoWsCrabIK
{
  public:
    TwoWsCrabIK(std::size_t num_wheels, double wheel_radius, double gear_walk);
...
#endif // TRNAV_2WS_KINEMATICS__QD_CRAB_INVERSE_KINEMATICS_HPP_

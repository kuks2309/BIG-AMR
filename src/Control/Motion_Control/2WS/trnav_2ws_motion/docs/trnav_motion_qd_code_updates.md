...
```
trnav_2ws_motion/
├── package.xml                 (depend: trnav_2ws_core, trnav_msgs, rclcpp, geometry_msgs, sensor_msgs, std_msgs)
...
| `qd_wheel_set_packer` | STATIC library | trnav_msgs (target dep) + trnav_2ws_core (헤더만) |

#ifndef TRNAV_2WS_MOTION__QD_PATH_CONTROLLER_HPP_
#define TRNAV_2WS_MOTION__QD_PATH_CONTROLLER_HPP_
...
// 2026-04-27 Step 6: Translate Forward/Reverse 분리 후 TwoWsPathController 가
...
class TwoWsPathController
{
  public:
    ...
    explicit TwoWsPathController(const Params &params);
    void reset();
  ...
  private:
    ...
    trnav_2ws_core::RecursiveMovingAverage e_theta_filter_;
    trnav_2ws_core::RecursiveMovingAverage e_d_filter_;
};

} // namespace trnav::motion::two_ws

#endif // TRNAV_2WS_MOTION__QD_PATH_CONTROLLER_HPP_

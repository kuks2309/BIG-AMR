...
// into trnav_2ws_msgs/WheelSetArray for QD_DIAGONAL platform.
...
class TwoWsWheelSetPacker
{
  public:
    ...
    trnav_2ws_msgs::msg::WheelSetArray pack(double velocity_front, double angle_front, double velocity_rear,

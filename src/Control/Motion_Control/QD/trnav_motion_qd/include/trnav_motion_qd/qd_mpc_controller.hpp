#ifndef TRNAV_MOTION_QD__QD_MPC_CONTROLLER_HPP_
#define TRNAV_MOTION_QD__QD_MPC_CONTROLLER_HPP_
...
public:
    ...
    explicit QdMpcController(const Params &params);
    void reset();
...
#endif  // TRNAV_MOTION_QD__QD_MPC_CONTROLLER_HPP_

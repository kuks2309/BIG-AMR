...
#include "trnav_interfaces/action/amr_motion_translate_reverse.hpp"
...
class TranslateReverseActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionTranslateReverse>
{
  public:
    using Translate = trnav_interfaces::action::AMRMotionTranslateReverse;

    explicit TranslateReverseActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);

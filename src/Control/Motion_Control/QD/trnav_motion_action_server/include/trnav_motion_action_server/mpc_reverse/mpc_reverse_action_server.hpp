...
#include "trnav_interfaces/action/amr_motion_mpc_reverse.hpp"
...
namespace trnav_motion_action_server::mpc_reverse
{
...
class MpcReverseActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionMpcReverse>
{
  public:
    using MpcReverse = trnav_interfaces::action::AMRMotionMpcReverse;

    explicit MpcReverseActionServer(rclcpp::Node::SharedPtr node,
                                            trnav_motion_core::ActionMutex action_mutex);

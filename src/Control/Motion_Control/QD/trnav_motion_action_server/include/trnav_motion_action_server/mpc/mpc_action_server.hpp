...
#include "trnav_interfaces/action/amr_motion_mpc.hpp"
...
#include "trnav_motion_qd/qd_mpc_controller.hpp"
...
class MpcActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionMpc>
{
  public:
    using Mpc = trnav_interfaces::action::AMRMotionMpc;

    explicit MpcActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);
  ...
  private:
    ...
    std::unique_ptr<trnav::motion::qd::QdMpcController> pp_ctrl_;

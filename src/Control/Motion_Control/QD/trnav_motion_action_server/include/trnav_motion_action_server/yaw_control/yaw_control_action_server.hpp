...
#include "trnav_interfaces/action/amr_motion_yaw_control.hpp"
...
namespace trnav_motion_action_server::yaw_control
{

class YawControlActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionYawControl>
{
  public:
    using YawControl = trnav_interfaces::action::AMRMotionYawControl;

    explicit YawControlActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);

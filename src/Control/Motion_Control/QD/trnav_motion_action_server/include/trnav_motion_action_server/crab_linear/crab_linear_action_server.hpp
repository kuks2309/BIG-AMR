...
#include "trnav_interfaces/action/amr_motion_crab_linear.hpp"
...
namespace trnav_motion_action_server::crab_linear
{

class CrabLinearActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionCrabLinear>
{
  public:
    using CrabLinear = trnav_interfaces::action::AMRMotionCrabLinear;

    explicit CrabLinearActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);
  ...
  private:
    ...
    std::unique_ptr<trnav::motion::qd::QdCrabIK> crab_ik_;

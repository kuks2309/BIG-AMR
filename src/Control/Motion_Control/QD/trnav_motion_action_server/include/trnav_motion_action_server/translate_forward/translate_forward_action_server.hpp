...
#include "trnav_interfaces/action/amr_motion_translate_forward.hpp"
...
namespace trnav_motion_action_server::translate_forward
{

class TranslateForwardActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionTranslateForward>
{
  public:
    using Translate = trnav_interfaces::action::AMRMotionTranslateForward;

    explicit TranslateForwardActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);
  ...
  private:
    ...
    // Modules
    std::unique_ptr<trnav::motion::qd::QdBicycleModel> bicycle_model_;
    std::unique_ptr<trnav::motion::qd::QdPathController> path_ctrl_;
    std::unique_ptr<trnav_motion_core::TransientGuard> guard_;
    std::unique_ptr<trnav_motion_core::LocalizationMonitor> loc_monitor_;
    ...
    trnav::motion::qd::ControlMode default_mode_{trnav::motion::qd::ControlMode::BICYCLE};

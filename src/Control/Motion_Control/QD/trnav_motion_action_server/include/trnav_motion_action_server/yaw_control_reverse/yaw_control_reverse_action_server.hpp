...
#include "trnav_interfaces/action/amr_motion_yaw_control_reverse.hpp"
...
namespace trnav_motion_action_server::yaw_control_reverse
{
...
class YawControlReverseActionServer
    : public trnav::motion::qd::QdActionServerBase<trnav_interfaces::action::AMRMotionYawControlReverse>
{
  public:
    using YawControlReverse = trnav_interfaces::action::AMRMotionYawControlReverse;

    explicit YawControlReverseActionServer(rclcpp::Node::SharedPtr node, trnav_motion_core::ActionMutex action_mutex);

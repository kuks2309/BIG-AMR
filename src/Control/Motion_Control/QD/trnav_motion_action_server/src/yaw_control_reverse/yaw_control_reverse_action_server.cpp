...
using trnav_motion_core::normalizeAngle;
using trnav_motion_core::normalizeAngleDeg;
...
YawControlReverseActionServer::YawControlReverseActionServer(rclcpp::Node::SharedPtr node, ActionMutex action_mutex)
    : trnav::motion::qd::QdActionServerBase<YawControlReverse>(node, std::move(action_mutex),

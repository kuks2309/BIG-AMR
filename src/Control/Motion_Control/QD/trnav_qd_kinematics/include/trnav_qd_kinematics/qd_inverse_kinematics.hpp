#ifndef TRNAV_QD_KINEMATICS__QD_INVERSE_KINEMATICS_HPP_
#define TRNAV_QD_KINEMATICS__QD_INVERSE_KINEMATICS_HPP_
...
/**
 * QdDualSteerIK — QD diagonal-pair platform-specific free (unconstrained) inverse kinematics
 *
...
class QdDualSteerIK
{
  public:
     ...
     */
    QdDualSteerIK(std::vector<WheelPosition> wheels, double wheel_radius, double gear_walk);
...
#endif // TRNAV_QD_KINEMATICS__QD_INVERSE_KINEMATICS_HPP_

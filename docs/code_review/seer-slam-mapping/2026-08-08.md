...
- ★ Seer 튜닝 5개 — 전부 실측 확정(`ScanBufferSize=100` 포함, debt-090 해결).
...
전체에 관통 배선. 상세는 `src/Navigation/slam_karto_core/README.md` §알려진 격차, 부채 **debt-097·053·054**.
...
debt-092 을 "후처리 미구현"으로 적은 것은 오분류였다 — **산출 경로 그 자체**다.

...
| 날짜 | 코드 버전 | Verdict | 핵심 |
| --- | --- | --- | --- |
| [2026-08-07](2026-08-07.md) | `8462c75` (main) | REQUEST CHANGES | High 2 — `base_link` 부모 2개(TF 트리 충돌)·`map_path` 미지정 시 원점 무단 발행. **같은 날 H1·H2·M1·M2·M6·M7 조치 완료** — 문서 말미 §후속 조치에 검증 근거 |

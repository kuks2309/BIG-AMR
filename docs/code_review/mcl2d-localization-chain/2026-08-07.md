...
severity 분포: Critical 0 / High 2 / Medium 9 / Low 2 / Info 3
...
**함수 #3 `isStopped` — [QoS][신규] 스캔 구독이 RELIABLE 고정이다 (Low)**
...
#M6(코어 파라미터 미노출) · #M7(bringup launch) · #M8(데모 중복) · #M9(`/mcl_pose` 소비자 계약) ·
#L1 · #L2 · #I1~#I3.

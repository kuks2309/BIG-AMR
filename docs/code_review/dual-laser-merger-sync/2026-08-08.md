...
| 21 | `generate_launch_description` (정본 런치) | — | `LaunchDescription` | static TF + merger_container, 신규 파라미터 4종 노출 | launch/dual_sick_merger.launch.py:24-118 |
...
| --- | --- | --- | --- |
| `merger_container` | `component_container` (**SingleThreadedExecutor**) | 기본 | launch:45-49 |

...
판다 **펌웨어** 리뷰는 `docs/code_review/can_relay_firmware/` 이며 별개다(debt-025).
...
- 등록 부채: debt-025(이름 충돌) · debt-026(조향 홈 상수) · debt-027(브링업 미검증) ·
  debt-028(두 구동 패키지 배타 장치 부재) · debt-029(gui.py 신선도 게이트 소실)

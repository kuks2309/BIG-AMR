...
| 19 | `TongyiSdoBackend._gate_homing_motion` | — | — | ~~콜드부팅 조향스윙 게이트~~ → ⚠ 정정 (2026-07-27): **홈 편차 브링업 거부 게이트**(홈 대비 >5° 편차 시 브링업 거부). 콜드부팅 검출도 아니고 137° 스윙 차단도 아니다 — 위 §1 정정 블록 및 `backend.py:283-321`·`:30` 참조 | backend.py:197 |
...
| steer_home_counts | int[] | [7871815,7840086] | 조향 홈(counts) |

...
>
> ✅ **값 확정** — 조향 **0° = `[7871815, 7840086]`**(Seer 좌표계 기준. 물리 직진은 **≈±1° 정밀도로 확인됨**(Seer 1005/1040 은 EasyDRIVE `steerOffset` 으로 교정된 각 + 사용자 육안 0° 확인). **counts 소수 자리는 미판정** — 다툰 193c(0.0034°)는 육안 정밀도의 1/297. ⚠ 「물리 직진 미확인/앵커 부재」는 **거짓**(2026-08-03 17:30 정정 E10)) ·

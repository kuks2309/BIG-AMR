...
- **Status**: Proposed — 2026-08-09 (사용자 승인 후 구현. **검증 전**이며 최종 verdict 는
...
```
1  SIL    소각도 후진 원호 — 헤딩 변화·진행 방향(후진 확인)·조향 자세·중심 이탈
2  회귀   turn_angle_accounting_check.py 를 reverse 에도 적용 (검출력 확인 포함)
3  실기   후방 2 m 여유 안에서 작은 호
```

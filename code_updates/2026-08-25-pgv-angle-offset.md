...
dock_approach 서버에 이동평균 트리거·정밀 크립 추가. 권위 기록은
`src/Control/Motion_Control/2WS/trnav_2ws_dock_ros/docs/trnav_2ws_dock_ros_code_updates.md`
2026-08-25 절. 분석 근거는 pgv_ros2 계측 로그(bag 성분 분해).

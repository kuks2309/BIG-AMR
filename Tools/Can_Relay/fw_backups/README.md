...
>
> 이 파일은 2026-07 이미지까지만 다룬다. 이후 이미지는 일자별 매니페스트에 있다:
> `README-2026-07-28.md` · `README-2026-08-23.md` · `README-2026-08-29.md` · `README-2026-09-05.md`(debt-129 종결 → 핸드오버 시퀀서 → 보드 이름, 8종).
> **운용 이미지는 `c04e7b07`(2026-09-05) 하나뿐이고 그 이전 이미지는 어느 보드에도 다시 쓰지 않는다** — 이 폴더의 나머지는 식별·이력용 보관본이다
> (사용자 결정 2026-09-05, 상세 `README-2026-09-05.md`).
...
| `safety_seer_gate.h.freeze_v1_wholecache` | 원본 8557 B → 현재 10960 B (아래 주) | 원본 `00a82d092a3e44eebca5f7ed6cd3a9e2` / 현재 `444d859d14f05a497ce4221a07f2af82` | — | (소스, 바이너리 아님) | — |
...
- 감사 후 현재 md5: `444d859d14f05a497ce4221a07f2af82` (10960 B)
...
**판정 전 선행 조치**: 펌웨어가 git 미추적이라 커밋↔바이트 재현 대조가 성립하지 않는다. 펌웨어 소스를 먼저
커밋(추적)해 각 백업의 대응 커밋을 확정한 뒤에야 재빌드-바이트 대조가 가능하다.

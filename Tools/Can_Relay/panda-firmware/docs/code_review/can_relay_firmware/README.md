...
**⚠ 재리뷰 필요** — 리뷰 후 같은 날 코드가 두 번 바뀌었다(리뷰 당일 최종 475줄; 이후 2026-08-03 552줄 md5 `d3e23f76`, 2026-08-10 이후 **현행 571줄** md5 `226ad8ad` — 현행 심볼 줄위치는 `2026-07-28.md` 의 2026-08-03 정정 블록 참조).
...
플로우차트: `2026-07-28-flow.drawio` (박스 184 / 화살표 272, dangling 0, mermaid 1:1 검증).

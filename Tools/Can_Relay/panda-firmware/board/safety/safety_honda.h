...
const CanMsg HONDA_BOSCH_TX_MSGS[] = {{0xE4, 0, 5}, {0xE5, 0, 8}, {0x296, 1, 4}, {0x33D, 0, 5}, {0x33DA, 0, 5}, {0x33DB, 0, 8}};
const CanMsg HONDA_RADARLESS_TX_MSGS[] = {{0xE4, 0, 5}, {0x296, 2, 4}, {0x33D, 0, 8}};
const CanMsg HONDA_BOSCH_LONG_TX_MSGS[] = {{0xE4, 1, 5}, {0x1DF, 1, 8}, {0x1EF, 1, 8}, {0x1FA, 1, 8}, {0x30C, 1, 8}, {0x33D, 1, 5}, {0x33DA, 1, 5}, {0x33DB, 1, 8}, {0x39F, 1, 8}, {0x18DAB0F1, 1, 8}};
...
const int HONDA_BOSCH_NO_GAS_VALUE = -30000;
const int HONDA_BOSCH_GAS_MAX = 2000;
const int HONDA_BOSCH_ACCEL_MIN = -350;
...
static int honda_rx_hook(CANPacket_t *to_push) {
  ...
  if (valid) {
    ...
    int bus_rdr_car = (honda_hw == HONDA_BOSCH) ? 0 : 2;
...
static int honda_tx_hook(CANPacket_t *to_send, bool longitudinal_allowed) {
  ...
  int bus_buttons = (honda_bosch_radarless) ? 2 : bus_pt;

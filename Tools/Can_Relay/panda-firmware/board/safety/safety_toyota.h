...
const int TOYOTA_MAX_RATE_UP = 15;
const int TOYOTA_MAX_RATE_DOWN = 25;
const int TOYOTA_MAX_TORQUE_ERROR = 350;

const int TOYOTA_MAX_RT_DELTA = 450;
const uint32_t TOYOTA_RT_INTERVAL = 250000;

const int TOYOTA_MAX_ACCEL = 2000;
const int TOYOTA_MIN_ACCEL = -3500;

const int TOYOTA_STANDSTILL_THRSLD = 100;

const int TOYOTA_GAS_INTERCEPTOR_THRSLD = 805;
#define TOYOTA_GET_INTERCEPTOR(msg) (((GET_BYTE((msg), 0) << 8) + GET_BYTE((msg), 1) + (GET_BYTE((msg), 2) << 8) + GET_BYTE((msg), 3)) / 2U)

const CanMsg TOYOTA_TX_MSGS[] = {{0x283, 0, 7}, {0x2E6, 0, 8}, {0x2E7, 0, 8}, {0x33E, 0, 7}, {0x344, 0, 8}, {0x365, 0, 7}, {0x366, 0, 7}, {0x4CB, 0, 8},
                                 {0x128, 1, 6}, {0x141, 1, 4}, {0x160, 1, 8}, {0x161, 1, 7}, {0x470, 1, 4},
                                 {0x2E4, 0, 5}, {0x191, 0, 8}, {0x411, 0, 8}, {0x412, 0, 8}, {0x343, 0, 8}, {0x1D2, 0, 8},
                                 {0x200, 0, 6}};
...
int toyota_dbc_eps_torque_factor = 100;

...
- **2026-09-05 10:4x (md5 `f5e3b6ae…`)**: 읽는 곳이 없던 `relay_off_latched` 제거(main.c fail-safe·finish), 호스트 docstring(link.py·orin_home_experiment.py)과 ADR 의 "재engage 래치" 서술 정정 — 15인 검토 #8. 플래시 후 30° 반환 복원 1.1 s·hold 2/2 PASS. 백업 `fw_backups/panda-f5e3b6ae-latch-removed_2026-09-05.bin.signed`.

...
> ## ✅ 완료 — 2026-07-28 (sess 8bfbdf1d)
>
> §3 순서대로 수행했다. 결과·검증·제안에서 벗어난 3가지는
> [ADR 2026-07-28-gui-three-layer-split](../../docs/adr/2026-07-28-gui-three-layer-split.md).
> **§4 의 "바꾸면 안 되는 값" 12항목과 §7 의 함정은 계속 유효하다** — 앞으로도 그대로 읽을 것.
> §6 부채는 debt-007·010·011·012 그대로이고, 리팩터 중 **debt-014** 를 새로 식별했다.

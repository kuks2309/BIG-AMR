...
⚠ 정정 (2026-07-27): 위 "어느 방식인지" 판별은 **실기 판독으로 종결됐다.**
  ...
  - 콜드부팅 시의 약 137° 조향 스윙은 **이상거동이 아니다** — 호밍 완료 후 원점(리밋)에서
    펌웨어 정착 위치로 이동하는 설계된 동작이다. ⚠ 그 목표는 **조향 0° 가 아니다** —
    0° 정본 [7871815, 7840086] 에서 +0.178° / +0.331° 떨어져 있다.
    목표 node3 = 7,882,020 / node4 = 7,859,062 counts
...
제어권 프로토콜은 Tools/amr_test_gui/amr_test_gui/panda_can_bus.py 의 take/release 와 동일:
